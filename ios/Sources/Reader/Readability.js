 ...
 *
 * This is the same library Firefox Reader View and Zen desktop use. It is
 * evaluated into the page lazily, only when reader mode is invoked — never as
 * a user script, which would trip `AutoFillSuppressionTests` and, worse, put a
 * form-aware script into every page a login is typed into.
 */
/*
